...
materi_header_old = "<tr><th>Modul / Judul</th><th>Kelas</th><th>Status</th><th style=\"text-align:center\">Aksi</th></tr>"
materi_header_new = """<tr>
...
materi_render_old = "      let html = '';\n      filtered.forEach((m, index) => {"
materi_render_new = """      if (sortState.materi.col) {
          filtered.sort((a, b) => {
              let valA = '', valB = '';
              if (sortState.materi.col === 'judul') {
                  valA = (getVal(a, ['judul', 'materi']) || "").toLowerCase();
                  valB = (getVal(b, ['judul', 'materi']) || "").toLowerCase();
...
# Update User Header
user_header_old = "<tr><th>Nama Pengguna</th><th>Username / NISN</th><th>Kelas</th><th style=\"text-align:center\">Aksi</th></tr>"
user_header_new = """<tr>
...
# Update User Render
user_render_old = "      let html = '';\n      filtered.forEach((u, index) => {"
user_render_new = """      if (sortState.user.col) {
          filtered.sort((a, b) => {
              let valA = '', valB = '';
